...
<template>
  <div class="md:h-full w-full p-4 overflow-y-hidden flex flex-col space-y-3 items-start justify-start md:pl-6 md:pr-0">
    <ExplorerSearcher></ExplorerSearcher>
    <ExplorerFieldSelector></ExplorerFieldSelector>

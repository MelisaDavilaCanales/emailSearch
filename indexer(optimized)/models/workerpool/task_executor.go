...
type TaskExecutor[Input any, Output any] func(workerIndex int, data Input) (result Output, err error) //nolint:unused // data is required for the function signature
